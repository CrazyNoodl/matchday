const tournament = {
  ...
  sheet: {
    ...
    closeAndDelete: 'Видалити турнір',
    deleteSubtitle: 'Жодного матчу ще не зіграно — архівувати нічого',
  },
  shareStandings: {
  ...
  close: {
    ...
    deleteDesc: 'Жодного матчу ще не зіграно, тож архівувати нічого. Замість цього турнір буде видалено назавжди.',
    delete: 'Видалити',
  },
  newRound: {
