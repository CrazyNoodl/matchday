const backup = {
  ...
  mediaLimitationNote: 'Les photos de joueurs, logos d\'équipes et photos/vidéos de match ne sont pas inclus dans cette sauvegarde.',
  ...
  restoreSyncFailed: 'Sauvegarde restaurée localement, mais la synchronisation avec le cloud a échoué.',
  ...
  importConfirmDesc: 'Cela remplace tous les joueurs, équipes et tournois de cet appareil par le contenu de cette sauvegarde, et — si la synchronisation cloud est activée — écrase vos données cloud pour correspondre. Ce n\'est pas une fusion, et cette action ne peut pas être annulée.',
