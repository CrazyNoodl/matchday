...
| Settings screen: iOS-style layout — account card (avatar, email, Sign Out below), grouped Play/Personalize/More sections (More is a plain list, not an accordion) | `app/settings/index.tsx` |
